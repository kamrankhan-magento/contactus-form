...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    const CP_META_TITTLE = 'contactus/seo_display/meta_tittle';
    const CP_META_KEYWORD = 'contactus/seo_display/meta_keyword';
    const CP_META_DESCRIPTION = 'contactus/seo_display/meta_description';
    const CP_PAGE_HEADING = 'contactus/seo_display/contact_heading';
    const CP_PAGE_DESCRIPTION = 'contactus/seo_display/contact_description';
    const CP_PAGE_LINK = 'contactus/seo_display/contact_link';
	...
	const XML_PATH_ALERT_SUCCESS = 'contactus/alert_messages/alert_success';
    const XML_PATH_ALERT_FAILURE = 'contactus/alert_messages/alert_failure';
 ...
 //////////////////////////////////////////////////////////////////////////////////////////
    ...
    {
        return $this->scopeConfig->getValue(
            self::XML_PATH_ALERT_SUCCESS,
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    }
    public function getAlertFailure()
    {
        return $this->scopeConfig->getValue(
            self::XML_PATH_ALERT_FAILURE,
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    }
}
